                                    ...
                                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                                        <ul class="navbar-nav text-uppercase">
                                            <li class="nav-item active">
                                                <a class="nav-link tm-nav-link" href="../../IMAGES_ARCHIVES/TOUR_2075">TOUR 2075<span class="sr-only">(current)</span></a>
                                            </li>
											<li class="nav-item">
                        ...
                        <div class="col-12">
                            ...
                            <div class="tm-categories-container mb-5">
                                ...
                                <ul class="nav tm-category-list">
                                    <li class="nav-item tm-category-item"><a href="IMAGES_ARCHIVES/TOUR_2075/index.php" class="nav-link tm-category-link active">NEW YEAR 2075</a></li>
